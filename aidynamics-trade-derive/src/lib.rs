...
pub fn api(args: TokenStream, item: TokenStream) -> TokenStream {
    ...
    let expanded = quote! {
        ...
        impl aidynamics_trade_utils::http::Api for #name {
            fn end_point() -> aidynamics_trade_utils::http::EndPoint {
                aidynamics_trade_utils::http::EndPoint::#end_point
            }
            fn url() -> String {
                Self::end_point().url()
            }
        ...
        impl aidynamics_trade_utils::http::#_trait for #name {}
    };
